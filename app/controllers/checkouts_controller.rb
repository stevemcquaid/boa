class CheckoutsController < ApplicationController
  ...
  def create_tool_checkout
    ...
    @tool = Tool.find_by_barcode(params[:tool_id])
    ...
    @participant = Participant.find_by_card(params[:participant_id].to_s) #this creates a CMU directory request to get the andrew id associated with the card number. Then finds the local DB mapping to get the participant id.
